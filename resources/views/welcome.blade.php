  ...
  <div class="modal fade" id="edit-task-modal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <button title="Cancelar" type="button" class="btn-close-modal btn btn-danger" data-bs-dismiss="modal"><i class="fa-solid fa-xmark"></i></button>
          <button id="btn-edit-task" title="Editar Nota" type="button" class="btn btn-primary"><i class="fa-solid fa-check"></i></button>
        </div>
      </div>
    </div>
  </div>
      ...
      <div class="col-md-3">
        <div class="card">
          <div class="card-body">
            ...
            <div class="btn-card">
              <button idtask='{{ $task->id }}' class="edit-task btn btn-primary"><i class="icons-buttons fa-solid fa-pen-to-square"></i></button>
